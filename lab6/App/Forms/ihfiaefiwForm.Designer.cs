...
namespace f_
{
	partial class v_Form
	{
		...
		{
			string str = JsonConvert.SerializeObject(D_.fN_(), Formatting.Indented);
			File.WriteAllText(D_.q_, str);
